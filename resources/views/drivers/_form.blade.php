...
<div>
    ...
    <br>
    <input type="date" id="license_expiry_date" name="license_expiry_date" value="{{ old('license_expiry_date', isset($driver->license_expiry_date) ? $driver->license_expiry_date->format('Y-m-d') : '') }}" required>
</div>
<br>
<div>
